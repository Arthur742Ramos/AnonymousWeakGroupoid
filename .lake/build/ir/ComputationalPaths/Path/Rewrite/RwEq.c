...
// Module: ComputationalPaths.Path.Rewrite.RwEq
// Imports: Init ComputationalPaths.Path.Basic ComputationalPaths.Path.Rewrite.Step ComputationalPaths.Path.Rewrite.Rw
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_ComputationalPaths_Path_Rewrite_RwEq(uint8_t builtin, lean_object* w) {
lean_object * res;
