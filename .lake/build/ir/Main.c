...
// Module: Main
// Imports: Init ComputationalPaths
#include <lean/lean.h>
...
{
lean_object* x_1; 
x_1 = lean_mk_string_unchecked("Computational Paths library version 0.1.0", 41, 41);
return x_1;
}
}
...
lean_object* initialize_ComputationalPaths(uint8_t builtin, lean_object*);
...
lean_dec_ref(res);
res = initialize_ComputationalPaths(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
